const CACHE = "sap-embodied-ai-v6";
const SHELL = ["/", "/styles.css", "/workspace.css", "/editor-ui.css", "/app.js?v=0.9.4-no-joule-chat", "/editor-core.js", "/robot-models.js", "/mesh-assets.js", "/webgl-world.js", "/manifest.webmanifest"];
