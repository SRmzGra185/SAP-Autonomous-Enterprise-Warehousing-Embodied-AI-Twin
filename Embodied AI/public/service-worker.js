const CACHE = "sap-embodied-ai-v7";
const SHELL = ["/", "/styles.css", "/workspace.css", "/editor-ui.css", "/app.js?v=0.9.5-joule-icon", "/editor-core.js", "/robot-models.js", "/mesh-assets.js", "/webgl-world.js", "/manifest.webmanifest"];
